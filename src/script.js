...
function gameboard(playerName, playerSelectedMarker) {
    ...
    //randomNumber generator for array index in names array for opponent AI
    function randomNum() {
    ...
    const winningBoards = [[0, 3, 6], [1, 4, 7], [2, 5, 8], [0, 1, 2], [3, 4, 5], [6, 7, 8], [0, 4, 8], [2, 4, 6]];
    const player = createPlayer(playerName, playerSelectedMarker);
    let winStatus = false;
    let opponent;
    const opponentName = names[randomNum()];

    //resets board after game start
    ...
    if (player.playerMarker == "X") {
        opponent = createPlayer(opponentName, "O");
    } else {
        opponent = createPlayer(opponentName, "X");
    }
    
    //displays createPlayer names and markers
    const player1Name = document.querySelector('.player1Name');
    const player2Name = document.querySelector('.player2Name');
    const player1Marker = document.querySelector('.playerMarker');
    const player2Marker = document.querySelector('.opponentMarker');

    player1Name.innerHTML = player.playerName;
    player2Name.innerHTML = opponent.playerName;
    player1Marker.innerHTML = player.playerMarker;
    player2Marker.innerHTML = opponent.playerMarker;
